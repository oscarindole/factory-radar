...
| | | |
|---|---|---|
| **Rosa RADACTORY** | `#E0115F` | El color de la marca. Identidad y nada más |
| **Naranja RADACTORY** | `#F59B00` | El cuadro del símbolo. Acompaña, no compite |
| Tinta | `#14161A` | Texto principal |
| Papel | `#F7F6F4` | Fondo claro |
