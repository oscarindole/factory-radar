...
const PARA = {
  ...
  'src/dominio/invitaciones.ts': 'Invitaciones: tres días de vigencia, el rol fijado al invitar y la regla que impide invitar por encima de uno mismo.',
  'src/api/rutas/invitaciones.ts': 'Crear, listar, revocar y canjear invitaciones. El canje no lleva sesión: quien acepta aún no tiene cuenta.',
  'tests/invitaciones.test.ts': '12 pruebas del dominio de invitaciones, sin base de datos.',
  'tests/invitaciones-api.test.ts': '13 pruebas de invitaciones contra base real: caducidad, rol, un solo uso y revocación.',
...
const CHIPS = {
  ...
  'doc/10-decisiones.md': { chip: '43', tono: 'teal' },
  'tests/invitaciones.test.ts': { chip: '12/12', tono: 'ok' },
  'tests/invitaciones-api.test.ts': { chip: '13/13', tono: 'ok' },
